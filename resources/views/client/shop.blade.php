                                    ...
                                    <div class="card-body">
                                        <div class="shop__sidebar__categories">
                                            <ul class="nice-scroll">
                                                ...
                                                <li><a href="#">Son (20)</a></li>
                                                <li><a href="#">Phấn (20)</a></li>
                                                <li><a href="#">Kẻ mắt (20)</a></li>
                                                <li><a href="#">Nước hoa (20)</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="product__item">
                            <div class="product__item__pic set-bg" data-setbg="/client/img/chulam/455971439_1177735816796946_4225547553999920568_n.jpg">
